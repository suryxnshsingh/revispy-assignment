    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className="md:border-[1px] border-[#c1c1c1] w-full border-0 sm:w-[35svw] rounded-2xl h-[70svh] mt-[3%] flex flex-col justify-center items-center ">
                    ...
                    <p className="text-lg font-semibold">Welcome back to ECOMMERCE</p>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col">
                        ...
                        <button 
                            type="submit"
                            className="bg-black text-white py-3 mt-8 rounded-sm">LOGIN</button>
                    </form>
                    <hr className="w-[30svw] mt-8"/>
                    <div className="mt-8 text-[#333333]">Don't have an account? <Link href="/signup" className="text-black">SIGNUP</Link></div>
            </div>
        </div>
    );
};
